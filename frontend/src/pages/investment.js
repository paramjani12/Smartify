...
const initialValue = {detail:"",start:"",maturity:"",amount:"",renewal:"",maturity_amount:""}
...
const url = `http://localhost:4000/investment`
const columnDefs = [
  { headerName: "Detail", field: "detail",},
  { headerName: "Start Date", field: "start", },
  { headerName: "Maturity", field: "maturity",},
  { headerName: "Investment Amount", field: "amount" },
  { headerName: "Renewal", field: "renewal" },
  { headerName: "Maturity Amount", field: "maturity_amount" },
  {
  ...
  return (
    <>
        ...
        <Container maxWidth="xl">
            ...
            >
                <img src={img1} alt="icon" style={{height:'46px', marginTop:'3px', paddingTop:'1px'}}/>
            </Typography>
            <Typography
                variant="h6"
                noWrap
        ...
        <DialogInvestment open={open} handleClose={handleClose}
        ...
        <Snackbar open={openSnack1} autoHideDuration={3000} onClose={handleCloseSnack1}>
          <Alert onClose={handleCloseSnack1} severity="error" sx={{ width: '100%' }}>
            Your investment detail is deleted!
          </Alert>
      </Snackbar>
      <Snackbar open={openSnack2} autoHideDuration={3000} onClose={handleCloseSnack2}>
          <Alert onClose={handleCloseSnack2} severity="info" sx={{ width: '100%' }}>
            Your investment detail is updated!
          </Alert>
      </Snackbar>
      <Snackbar open={openSnack3} autoHideDuration={3000} onClose={handleCloseSnack3}>
          <Alert onClose={handleCloseSnack3} severity="success" sx={{ width: '100%' }}>
            Your investment detail is added successfully!
          </Alert>
      </Snackbar>
