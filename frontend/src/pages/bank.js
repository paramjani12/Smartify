...
const initialValue = {bank:"", holder:"", number:"", customerid:"", ifsc:"", note:""}
...
const url = `http://localhost:4000/bank`
const columnDefs = [
  { headerName: "Bank Name", field: "bank",},
  { headerName: "Account Holder", field: "holder",},
  { headerName: "Account Number", field: "number", },
...
const handleCloseSnack3 = (event, reason) => {
  ...
  return (
    <>
        ...
        <DialogBank open={open} handleClose={handleClose}
      ...
      <Snackbar open={openSnack3} autoHideDuration={3000} onClose={handleCloseSnack3}>
          <Alert onClose={handleCloseSnack3} severity="success" sx={{ width: '100%' }}>
            Your bank detail is added successfully!
          </Alert>
      </Snackbar>
