...
export default function DialogProfessional({open,handleClose,data,onChange,handleFormSubmit}) {
 const {id,taskname,client,deadline,priority,incharge,note}=data
