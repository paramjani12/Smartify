...
const initialValue = {particular:"", amount:"", date:"", category:"", method:"", note:""}
...
const columnDefs = [
  ...
  { headerName: "Payment Method", field: "method" },
...
const handleCloseSnack3 = (event, reason) => {
  ...
  return (
    <>
        ...
        <DialogExpense open={open} handleClose={handleClose}
        data={formData} onChange={onChange} handleFormSubmit={handleFormSubmit} />
        

        
        <ExpenseChart open1={open1} handleClose1={handleClose1}/>
        ...
        <Snackbar open={openSnack1} autoHideDuration={3000} onClose={handleCloseSnack1}>
          <Alert onClose={handleCloseSnack1} severity="error" sx={{ width: '100%' }}>
            Your expense detail is deleted!
          </Alert>
      </Snackbar>
      <Snackbar open={openSnack2} autoHideDuration={3000} onClose={handleCloseSnack2}>
          <Alert onClose={handleCloseSnack2} severity="info" sx={{ width: '100%' }}>
            Your expense detail is updated!
          </Alert>
      </Snackbar>
