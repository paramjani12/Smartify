...
import DialogProfessional from './dialogprofessional';
...
const initialValue = {taskname:"", client:"", deadline:"", priority:"", incharge:"", note:""}
...
const url = `http://localhost:4000/professional`
const columnDefs = [
  { headerName: "Task Name", field: "taskname", checkboxSelection:true},
  { headerName: "Client", field: "client", },
  { headerName: "Deadline", field: "deadline", sortable: true},
...
const handleCloseSnack3 = (event, reason) => {
  ...
  return (
    <>
        ...
        <div className="ag-theme-alpine" style={{ height: 665, width: 1515  }}>
         <AgGridReact 
            rowData={tableData}
        ...
        <DialogProfessional open={open} handleClose={handleClose}
